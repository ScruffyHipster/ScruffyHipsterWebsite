...
To stop doomscrolling, make the trigger harder to complete. The trigger is usually not a thoughtful decision to spend half an hour in a feed. It is a small reflex: unlock, tap, scroll, repeat. A useful setup interrupts that reflex before the feed opens.
...
3. Add a pause before access instead of relying on willpower after the feed opens.
4. Review patterns without judging every attempt.
