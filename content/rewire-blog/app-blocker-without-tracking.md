...
If you want an app blocker without tracking, start with the privacy model before the feature list. The safest signs are simple: no required account, no advertising business model, no personal data collection, and a privacy policy that says what is collected in plain language.
...
- Does it collect personal data or sell data?
- Does it need cloud sync for basic blocking?
