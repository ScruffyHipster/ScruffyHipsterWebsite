...
Once the devices reconnect, completed sessions sync back to the iPhone history. You can then review, edit, or export the saved information on the larger screen.

# When your iPhone is out of reach

The watch app is built to remain useful when the phone is in another room or temporarily unavailable. An active session belongs to the feed you started, rather than to a permanently open phone screen.

Offline support is about reliable logging, not health monitoring. The app records the time, duration, and selected side; it does not decide when the next feed should happen or judge whether a session was long enough.
