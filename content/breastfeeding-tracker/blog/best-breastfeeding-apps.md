...
For practical help with its focused workflow, see how to [time a breastfeed on iPhone](/breastfeeding-tracker/support/breastfeeding-timer-iphone/), [track left and right sides](/breastfeeding-tracker/support/track-left-and-right-side/), [use the Apple Watch app](/breastfeeding-tracker/support/breastfeeding-tracker-apple-watch/), [edit a missed feeding log](/breastfeeding-tracker/support/edit-missed-feeding-logs/), [export selected history as a PDF](/breastfeeding-tracker/support/export-breastfeeding-log-pdf/), and understand the [private breastfeeding tracker approach](/breastfeeding-tracker/support/private-breastfeeding-tracker/).
